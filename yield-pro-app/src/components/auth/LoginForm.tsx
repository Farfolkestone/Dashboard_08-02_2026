        ...
        <div className="w-full max-w-md p-8 bg-card rounded-xl shadow-lg border">
            <div className="flex flex-col items-center mb-8">
                ...
                <p className="text-muted-foreground text-center mt-2">
                    Accédez à votre dashboard YieldManager Pro
                </p>
            </div>
            ...
            <div className="mt-6 flex flex-col gap-3">
                <div className="relative py-2 flex items-center">
                    ...
                    <span className="flex-shrink mx-4 text-xs text-muted-foreground uppercase">Ou continuer avec</span>
                    <div className="flex-grow border-t"></div>
                </div>

                <button
                    onClick={handleGoogleLogin}
                    className="w-full py-2 bg-background border hover:bg-muted text-foreground font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
                >
